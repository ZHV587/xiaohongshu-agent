  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
        <span style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", fontWeight: "var(--weight-medium)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{label}</span>
        {icon && (
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
        {editable ? (
          ...
          <span className="font-tabular" style={{ fontFamily: "var(--font-display)", fontWeight: "var(--weight-black)", fontSize: "var(--text-2xl)", color: tones[tone], lineHeight: 1 }}>
            {value}
          </span>
        )}
      ...
      {delta != null && (
        <span style={{ display: "inline-flex", alignItems: "center", gap: 3, fontSize: "var(--text-2xs)", fontWeight: "var(--weight-semibold)", color: deltaUp ? "var(--success)" : "var(--text-muted)" }}>
          <span>{deltaUp ? "▲" : "▼"}</span>
