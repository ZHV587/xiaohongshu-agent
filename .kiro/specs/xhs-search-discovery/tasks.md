...
- [ ] 3. 发现专用本地检索工具 `search_local_note_cards`
...
- [ ] 4. 线上检索工具 `search_xhs_online`(红狐 API)
...
- [ ] 5. 采纳核心 `adopt_online_notes_resource` + agent 工具
...
- [ ] 6. 飞书爆款采集库同步工具 `sync_online_note_to_feishu`(自然键去重)
